...
pp:
	...
	lea	    esi, [ enc_string1 ]
	add	    esi, edx
	add	    esi, strict dword ( _start - pp )

	lea	    ecx, [ value ]
	add	    ecx, edx
	add	    ecx, strict dword ( _start - pp )
	mov	    [ ecx ], esi


	mov	    ecx, strict dword ( enc_string1_end - enc_string1 )
	push	ecx
	...
	mov	    ecx, strict dword ( dec_string1_end - dec_string1 )
	push	ecx
